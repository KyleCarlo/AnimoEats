...
### Required Features
- View establishments
    - Landing page - <strong>unregistered visitor may see a list of establishments</strong> that are featured in the web application.
...
- View an establishment's reviews
    ...
    - The user can also <strong>see the next set of top reviews.</strong> 
        - <strong><em>FOR DISCUSSION</em></strong> Either the next set will <strong>auto-reload or load in another page.</strong>
...
- Register
    ...
    - Registration - <strong>username, password,</strong> avatar (not required), and short description (not required).
- Login
    ...
    - Once remembered, every log in and visit to the website will <strong>extend their "remember" period by 3 weeks.</strong>
- Logout
...
- Search Establishments / Reviews
    ...
    - Visitors can <strong>search on an establishment based on the title or body</strong> of the review.
- Establishment owner response
    - Account role function - establishment <strong>owner.</strong>
    - <strong>Does not need to be integrated with the register system.</strong> Can be created manually by the databse admin.
